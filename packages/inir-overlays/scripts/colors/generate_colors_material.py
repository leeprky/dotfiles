...
if args.render_templates:
    ...
    # Firefox/Zen theme post-hook: apply MaterialFox colors to browser profiles
    firefox_apply = os.path.join(
        os.path.dirname(os.path.abspath(__file__)), "apply-firefox-theme.sh"
    )
    if os.path.isfile(firefox_apply):
        import subprocess
