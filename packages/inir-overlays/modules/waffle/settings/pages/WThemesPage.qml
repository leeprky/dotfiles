...
WSettingsPage {
    ...
    WSettingsCard {
        ...
        WSettingsSwitch {
            label: Translation.tr("Firefox / Zen Browser")
            icon: "globe"
            description: Translation.tr("Apply wallpaper-derived colors to Firefox, Zen Browser, LibreWolf, and other Firefox forks")
